...
// float32AsWebhookTypes is a convenience function that returns float32 wrapped in WebhookTypes
func Float32AsWebhookTypes(v *float32) WebhookTypes {
	return WebhookTypes{
		Float32: v,
	}
}
...
func (dst *WebhookTypes) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(WebhookTypes)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(WebhookTypes)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src WebhookTypes) MarshalJSON() ([]byte, error) {
	if src.Float32 != nil {
...
func (obj *WebhookTypes) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Float32 != nil {
