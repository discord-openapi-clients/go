...
// checks if the MessageComponentUserSelectResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageComponentUserSelectResponse{}

// MessageComponentUserSelectResponse struct for MessageComponentUserSelectResponse
type MessageComponentUserSelectResponse struct {
	...
	DefaultValues []UserSelectDefaultValueResponse `json:"default_values,omitempty"`
}

type _MessageComponentUserSelectResponse MessageComponentUserSelectResponse
...
func NewMessageComponentUserSelectResponse(type_ MessageComponentTypes, id int32, customId string) *MessageComponentUserSelectResponse {
	this := MessageComponentUserSelectResponse{}
	this.Type = type_
	this.Id = id
...
func (o *MessageComponentUserSelectResponse) SetPlaceholderNil() {
...
func (o *MessageComponentUserSelectResponse) SetMinValuesNil() {
	o.MinValues.Set(nil)
}
...
func (o *MessageComponentUserSelectResponse) SetMaxValuesNil() {
	o.MaxValues.Set(nil)
}
...
func (o *MessageComponentUserSelectResponse) SetDisabledNil() {
	o.Disabled.Set(nil)
}
...
func (o *MessageComponentUserSelectResponse) GetDefaultValues() []UserSelectDefaultValueResponse {
	if o == nil {
		var ret []UserSelectDefaultValueResponse
		return ret
	}
...
// SetDefaultValues gets a reference to the given []UserSelectDefaultValueResponse and assigns it to the DefaultValues field.
func (o *MessageComponentUserSelectResponse) SetDefaultValues(v []UserSelectDefaultValueResponse) {
	o.DefaultValues = v
}

func (o MessageComponentUserSelectResponse) MarshalJSON() ([]byte, error) {
...
func (o MessageComponentUserSelectResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MessageComponentUserSelectResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMessageComponentUserSelectResponse := _MessageComponentUserSelectResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMessageComponentUserSelectResponse)

	if err != nil {
		return err
	}

	*o = MessageComponentUserSelectResponse(varMessageComponentUserSelectResponse)

	return err
}

type NullableMessageComponentUserSelectResponse struct {
	value *MessageComponentUserSelectResponse
	isSet bool
}

func (v NullableMessageComponentUserSelectResponse) Get() *MessageComponentUserSelectResponse {
	return v.value
}

func (v *NullableMessageComponentUserSelectResponse) Set(val *MessageComponentUserSelectResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMessageComponentUserSelectResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMessageComponentUserSelectResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMessageComponentUserSelectResponse(val *MessageComponentUserSelectResponse) *NullableMessageComponentUserSelectResponse {
	return &NullableMessageComponentUserSelectResponse{value: val, isSet: true}
}

func (v NullableMessageComponentUserSelectResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMessageComponentUserSelectResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
