...
// checks if the SettingsEmojiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SettingsEmojiResponse{}

// SettingsEmojiResponse struct for SettingsEmojiResponse
...
func (o *SettingsEmojiResponse) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SettingsEmojiResponse) SetAnimatedNil() {
	o.Animated.Set(nil)
}
...
func (o SettingsEmojiResponse) MarshalJSON() ([]byte, error) {
...
func (o SettingsEmojiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSettingsEmojiResponse struct {
	value *SettingsEmojiResponse
	isSet bool
}

func (v NullableSettingsEmojiResponse) Get() *SettingsEmojiResponse {
	return v.value
}

func (v *NullableSettingsEmojiResponse) Set(val *SettingsEmojiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSettingsEmojiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSettingsEmojiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSettingsEmojiResponse(val *SettingsEmojiResponse) *NullableSettingsEmojiResponse {
	return &NullableSettingsEmojiResponse{value: val, isSet: true}
}

func (v NullableSettingsEmojiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSettingsEmojiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
