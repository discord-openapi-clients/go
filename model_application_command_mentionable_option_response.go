...
// checks if the ApplicationCommandMentionableOptionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationCommandMentionableOptionResponse{}

// ApplicationCommandMentionableOptionResponse struct for ApplicationCommandMentionableOptionResponse
...
type _ApplicationCommandMentionableOptionResponse ApplicationCommandMentionableOptionResponse
...
func NewApplicationCommandMentionableOptionResponse(type_ ApplicationCommandOptionType, name string, description string) *ApplicationCommandMentionableOptionResponse {
	this := ApplicationCommandMentionableOptionResponse{}
	this.Type = type_
	this.Name = name
...
func (o *ApplicationCommandMentionableOptionResponse) SetNameLocalizedNil() {
...
func (o *ApplicationCommandMentionableOptionResponse) SetDescriptionLocalizedNil() {
...
func (o *ApplicationCommandMentionableOptionResponse) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o ApplicationCommandMentionableOptionResponse) MarshalJSON() ([]byte, error) {
...
func (o ApplicationCommandMentionableOptionResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationCommandMentionableOptionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationCommandMentionableOptionResponse := _ApplicationCommandMentionableOptionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplicationCommandMentionableOptionResponse)

	if err != nil {
		return err
	}

	*o = ApplicationCommandMentionableOptionResponse(varApplicationCommandMentionableOptionResponse)

	return err
}

type NullableApplicationCommandMentionableOptionResponse struct {
	value *ApplicationCommandMentionableOptionResponse
	isSet bool
}

func (v NullableApplicationCommandMentionableOptionResponse) Get() *ApplicationCommandMentionableOptionResponse {
	return v.value
}

func (v *NullableApplicationCommandMentionableOptionResponse) Set(val *ApplicationCommandMentionableOptionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationCommandMentionableOptionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationCommandMentionableOptionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationCommandMentionableOptionResponse(val *ApplicationCommandMentionableOptionResponse) *NullableApplicationCommandMentionableOptionResponse {
	return &NullableApplicationCommandMentionableOptionResponse{value: val, isSet: true}
}

func (v NullableApplicationCommandMentionableOptionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationCommandMentionableOptionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
