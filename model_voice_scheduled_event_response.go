...
// checks if the VoiceScheduledEventResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VoiceScheduledEventResponse{}

// VoiceScheduledEventResponse struct for VoiceScheduledEventResponse
...
type _VoiceScheduledEventResponse VoiceScheduledEventResponse
...
func NewVoiceScheduledEventResponse(id string, guildId string, name string, scheduledStartTime time.Time, status GuildScheduledEventStatuses, entityType GuildScheduledEventEntityTypes, privacyLevel GuildScheduledEventPrivacyLevels) *VoiceScheduledEventResponse {
	this := VoiceScheduledEventResponse{}
	this.Id = id
...
func (o *VoiceScheduledEventResponse) SetDescriptionNil() {
...
func (o *VoiceScheduledEventResponse) SetCreatorNil() {
	o.Creator.Set(nil)
}
...
func (o *VoiceScheduledEventResponse) SetImageNil() {
	o.Image.Set(nil)
}
...
func (o *VoiceScheduledEventResponse) SetScheduledEndTimeNil() {
...
func (o *VoiceScheduledEventResponse) SetUserCountNil() {
	o.UserCount.Set(nil)
}
...
func (o *VoiceScheduledEventResponse) SetUserRsvpNil() {
	o.UserRsvp.Set(nil)
}
...
func (o VoiceScheduledEventResponse) MarshalJSON() ([]byte, error) {
...
func (o VoiceScheduledEventResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VoiceScheduledEventResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVoiceScheduledEventResponse := _VoiceScheduledEventResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVoiceScheduledEventResponse)

	if err != nil {
		return err
	}

	*o = VoiceScheduledEventResponse(varVoiceScheduledEventResponse)

	return err
}

type NullableVoiceScheduledEventResponse struct {
	value *VoiceScheduledEventResponse
	isSet bool
}

func (v NullableVoiceScheduledEventResponse) Get() *VoiceScheduledEventResponse {
	return v.value
}

func (v *NullableVoiceScheduledEventResponse) Set(val *VoiceScheduledEventResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVoiceScheduledEventResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVoiceScheduledEventResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoiceScheduledEventResponse(val *VoiceScheduledEventResponse) *NullableVoiceScheduledEventResponse {
	return &NullableVoiceScheduledEventResponse{value: val, isSet: true}
}

func (v NullableVoiceScheduledEventResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoiceScheduledEventResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
