...
// float32AsStageInstancesPrivacyLevels is a convenience function that returns float32 wrapped in StageInstancesPrivacyLevels
func Float32AsStageInstancesPrivacyLevels(v *float32) StageInstancesPrivacyLevels {
	return StageInstancesPrivacyLevels{
		Float32: v,
	}
}
...
func (dst *StageInstancesPrivacyLevels) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(StageInstancesPrivacyLevels)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(StageInstancesPrivacyLevels)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src StageInstancesPrivacyLevels) MarshalJSON() ([]byte, error) {
	if src.Float32 != nil {
...
func (obj *StageInstancesPrivacyLevels) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Float32 != nil {
