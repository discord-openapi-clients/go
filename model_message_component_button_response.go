...
// checks if the MessageComponentButtonResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageComponentButtonResponse{}

// MessageComponentButtonResponse struct for MessageComponentButtonResponse
type MessageComponentButtonResponse struct {
...
type _MessageComponentButtonResponse MessageComponentButtonResponse
...
func NewMessageComponentButtonResponse(type_ MessageComponentTypes, id int32, style ButtonStyleTypes) *MessageComponentButtonResponse {
	this := MessageComponentButtonResponse{}
	this.Type = type_
	this.Id = id
	this.Style = style
	return &this
...
func (o *MessageComponentButtonResponse) SetCustomIdNil() {
	o.CustomId.Set(nil)
}
...
func (o *MessageComponentButtonResponse) SetLabelNil() {
	o.Label.Set(nil)
}
...
func (o *MessageComponentButtonResponse) SetDisabledNil() {
	o.Disabled.Set(nil)
}
...
func (o *MessageComponentButtonResponse) SetEmojiNil() {
	o.Emoji.Set(nil)
}
...
func (o *MessageComponentButtonResponse) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o MessageComponentButtonResponse) MarshalJSON() ([]byte, error) {
...
func (o MessageComponentButtonResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MessageComponentButtonResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMessageComponentButtonResponse := _MessageComponentButtonResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMessageComponentButtonResponse)

	if err != nil {
		return err
	}

	*o = MessageComponentButtonResponse(varMessageComponentButtonResponse)

	return err
}

type NullableMessageComponentButtonResponse struct {
	value *MessageComponentButtonResponse
	isSet bool
}

func (v NullableMessageComponentButtonResponse) Get() *MessageComponentButtonResponse {
	return v.value
}

func (v *NullableMessageComponentButtonResponse) Set(val *MessageComponentButtonResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMessageComponentButtonResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMessageComponentButtonResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMessageComponentButtonResponse(val *MessageComponentButtonResponse) *NullableMessageComponentButtonResponse {
	return &NullableMessageComponentButtonResponse{value: val, isSet: true}
}

func (v NullableMessageComponentButtonResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMessageComponentButtonResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
