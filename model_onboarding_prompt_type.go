...
// float32AsOnboardingPromptType is a convenience function that returns float32 wrapped in OnboardingPromptType
func Float32AsOnboardingPromptType(v *float32) OnboardingPromptType {
...
func (dst *OnboardingPromptType) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(OnboardingPromptType)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(OnboardingPromptType)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src OnboardingPromptType) MarshalJSON() ([]byte, error) {
	if src.Float32 != nil {
...
func (obj *OnboardingPromptType) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Float32 != nil {
