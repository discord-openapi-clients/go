...
// float32AsGuildScheduledEventPrivacyLevels is a convenience function that returns float32 wrapped in GuildScheduledEventPrivacyLevels
func Float32AsGuildScheduledEventPrivacyLevels(v *float32) GuildScheduledEventPrivacyLevels {
	return GuildScheduledEventPrivacyLevels{
		Float32: v,
	}
}
...
func (dst *GuildScheduledEventPrivacyLevels) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(GuildScheduledEventPrivacyLevels)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(GuildScheduledEventPrivacyLevels)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GuildScheduledEventPrivacyLevels) MarshalJSON() ([]byte, error) {
	if src.Float32 != nil {
...
func (obj *GuildScheduledEventPrivacyLevels) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Float32 != nil {
