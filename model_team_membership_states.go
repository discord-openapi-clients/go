...
type NullableTeamMembershipStates struct {
	value *TeamMembershipStates
	isSet bool
}

func (v NullableTeamMembershipStates) Get() *TeamMembershipStates {
	return v.value
}

func (v *NullableTeamMembershipStates) Set(val *TeamMembershipStates) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamMembershipStates) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamMembershipStates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamMembershipStates(val *TeamMembershipStates) *NullableTeamMembershipStates {
	return &NullableTeamMembershipStates{value: val, isSet: true}
}

func (v NullableTeamMembershipStates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamMembershipStates) UnmarshalJSON(src []byte) error {
	v.isSet = true
