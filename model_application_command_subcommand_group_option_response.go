...
// checks if the ApplicationCommandSubcommandGroupOptionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationCommandSubcommandGroupOptionResponse{}

// ApplicationCommandSubcommandGroupOptionResponse struct for ApplicationCommandSubcommandGroupOptionResponse
type ApplicationCommandSubcommandGroupOptionResponse struct {
	...
	Options []ApplicationCommandSubcommandOptionResponse `json:"options,omitempty"`
}

type _ApplicationCommandSubcommandGroupOptionResponse ApplicationCommandSubcommandGroupOptionResponse
...
func NewApplicationCommandSubcommandGroupOptionResponse(type_ ApplicationCommandOptionType, name string, description string) *ApplicationCommandSubcommandGroupOptionResponse {
	this := ApplicationCommandSubcommandGroupOptionResponse{}
	this.Type = type_
	this.Name = name
...
func (o *ApplicationCommandSubcommandGroupOptionResponse) SetNameLocalizedNil() {
...
func (o *ApplicationCommandSubcommandGroupOptionResponse) SetDescriptionLocalizedNil() {
...
func (o *ApplicationCommandSubcommandGroupOptionResponse) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ApplicationCommandSubcommandGroupOptionResponse) GetOptions() []ApplicationCommandSubcommandOptionResponse {
	if o == nil {
		var ret []ApplicationCommandSubcommandOptionResponse
		return ret
	}
	return o.Options
}
...
// SetOptions gets a reference to the given []ApplicationCommandSubcommandOptionResponse and assigns it to the Options field.
func (o *ApplicationCommandSubcommandGroupOptionResponse) SetOptions(v []ApplicationCommandSubcommandOptionResponse) {
	o.Options = v
}

func (o ApplicationCommandSubcommandGroupOptionResponse) MarshalJSON() ([]byte, error) {
...
func (o ApplicationCommandSubcommandGroupOptionResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationCommandSubcommandGroupOptionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationCommandSubcommandGroupOptionResponse := _ApplicationCommandSubcommandGroupOptionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplicationCommandSubcommandGroupOptionResponse)

	if err != nil {
		return err
	}

	*o = ApplicationCommandSubcommandGroupOptionResponse(varApplicationCommandSubcommandGroupOptionResponse)

	return err
}

type NullableApplicationCommandSubcommandGroupOptionResponse struct {
	value *ApplicationCommandSubcommandGroupOptionResponse
	isSet bool
}

func (v NullableApplicationCommandSubcommandGroupOptionResponse) Get() *ApplicationCommandSubcommandGroupOptionResponse {
	return v.value
}

func (v *NullableApplicationCommandSubcommandGroupOptionResponse) Set(val *ApplicationCommandSubcommandGroupOptionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationCommandSubcommandGroupOptionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationCommandSubcommandGroupOptionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationCommandSubcommandGroupOptionResponse(val *ApplicationCommandSubcommandGroupOptionResponse) *NullableApplicationCommandSubcommandGroupOptionResponse {
	return &NullableApplicationCommandSubcommandGroupOptionResponse{value: val, isSet: true}
}

func (v NullableApplicationCommandSubcommandGroupOptionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationCommandSubcommandGroupOptionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
